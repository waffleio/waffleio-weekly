...
module.exports.getIssuesForRepo = async function(repo, state, daysSince) {
  ghApiCount++

  const repoAndOwner = repo.split('/')
  const since = moment().subtract(daysSince, 'days')
